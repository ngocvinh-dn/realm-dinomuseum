...
const navLinks = [
  ...
  {
    id: "timeline",
    label: { vi: "Dòng thời gian", en: "Timeline" },
    href: "#timeline",
  },
  {
    id: "specimens",
    label: { vi: "Hiện vật", en: "Specimens" },
    href: "#specimens",
  },
  {
    id: "explore-globe",
    label: { vi: "Khám phá", en: "Explore" },
    href: "#explore-globe",
    isExplore: true,
  },
  {
    id: "dang-ky",
    label: { vi: "Đăng ký vé", en: "Tickets" },
    href: "#dang-ky",
  },
];
            ...
            {navLinks.map((link) => {
              ...
              return (
                <motion.button
                  key={link.id}
                  ref={(el) => {
                    if (el) tabRefs.current[link.id] = el;
                  }}
                  onClick={() => handleNavClick(link.href, link.id)}
                  onMouseEnter={() => handleNavMouseEnter(link.id)}
                  className="relative z-10 px-6 py-1.5 font-semibold rounded-full cursor-pointer"
                  animate={{
                    color: isActive
                      ? "#f59e0b"
                      : isHovered
