    ...
    <section id="hero" ref={sectionRef} className="relative w-full min-h-screen flex flex-col items-center justify-center text-center overflow-y-hidden" style={{ paddingTop: '80px', overflowX: 'visible' }}>
      ...
      <motion.div className="relative z-10 max-w-6xl mx-auto px-6" style={{ y: smoothContentY, opacity: contentOpacity }}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: 'easeOut' }}>
          ...
          <motion.h1 className="hero-title font-serif" style={{ fontFamily: 'var(--font-heading)', color: 'var(--theme-heading)' }}>
            <span className="hero-title__main">{copy.heroTitle}</span>
            <motion.span className="hero-title__accent text-gradient-gold italic">{copy.heroSubtitle}</motion.span>
          </motion.h1>
