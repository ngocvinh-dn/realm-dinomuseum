  ...
  if (!dino) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center space-y-4 px-6">
        ...
        <div>
          <p
            className="uppercase tracking-[0.2em] text-xs font-bold mb-1"
            style={{
        ...
        <div className="w-full space-y-2 mt-2">
          ...
          >
            ...
            <div className="text-left flex-1">
              ...
              >
                {lang === "en"
                  ? "Tap green marker to explore"
                  : "Bấm điểm xanh để xem chi tiết"}
              </p>
            </div>
            <div
              className="px-2 py-0.5 rounded-full flex-shrink-0"
      ...
      >
        {dino.image_url ? (
          ...
          <div
            ...
            style={{ background: "rgba(30,23,16,0.9)" }}
          >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 20%, rgba(10,8,4,1) 100%)",
          }}
        />
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {f(dino, "fossil_parts", lang) && (
          <div className="space-y-2">
            ...
            <div
              className="px-3 py-2.5 rounded-r-xl border-l-4"
              style={{
                background: "rgba(245,158,11,0.04)",
        ...
        >
          <span>📍</span>
          <span>
            {[dino.location_province, dino.country].filter(Boolean).join(", ")}
          </span>
        </div>
      </div>
    </motion.div>
...
const MuseumPanel = ({ museum, lang }) => {
  ...
  const description =
    lang === "en" ? museum.description_en : museum.description_vi;
  const notable =
    lang === "en" ? museum.notable_specimen_en : museum.notable_specimen_vi;
  ...
  return (
    ...
    >
      ...
      <div
        className="relative overflow-hidden flex-shrink-0 flex items-end"
        style={{
          height: "200px",
          background:
            "linear-gradient(135deg, rgba(5,30,12,1) 0%, rgba(8,22,10,1) 100%)",
        }}
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 25%, rgba(5,15,8,0.98) 100%)",
          }}
        />
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {museum.founded_year && (
          <div className="flex gap-3">
            <div
              className="flex-1 flex flex-col items-center justify-center p-3 rounded-xl text-center"
              style={{
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  {parseFloat(museum.latitude).toFixed(3)}°,{" "}
                  {parseFloat(museum.longitude).toFixed(3)}°
                </p>
              </div>
            </div>
          </div>
        ...
        {museum.website && (
          <a
            ...
            onMouseLeave={(e) =>
              (e.currentTarget.style.color = "rgba(34,197,94,0.5)")
            }
          >
            <span>🔗</span>
            <span style={{ fontSize: "11px" }}>
              {labelWeb}: {museum.website.replace("https://", "")}
            </span>
          </a>
        )}
      </div>
...
const GlobePage = () => {
  ...
  const handleMuseumSelect = (museum) => {
    ...
    viewer.camera.flyTo({
      destination: Cartesian3.fromDegrees(
        Number(museum.longitude),
        Number(museum.latitude),
        1000,
      ),
      orientation: { heading: 0, pitch: -Math.PI / 2, roll: 0 },
      duration: 2.8,
              ...
              <PointGraphics
                ...
                color={
                  selectedMuseum?.id === museum.id
                    ...
                    : Color.fromCssColorString("rgba(34,197,94,0.85)")
                }
                outlineColor={Color.WHITE}
          ...
          >
            ...
            <div className="flex-1 overflow-hidden relative">
              <AnimatePresence mode="wait">
                {selectedMuseum ? (
                  <MuseumPanel
                    key={`museum-${selectedMuseum.id}-${lang}`}
                    museum={selectedMuseum}
                    lang={lang}
                  />
                ) : (
                  <DinoPanel
                    key={`${selectedDino?.id ?? "empty"}-${lang}`}
                    dino={selectedDino}
                    total={dinos.length}
